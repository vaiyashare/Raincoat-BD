  ...
  return (
    <section className="py-16 bg-slate-50 border-t border-slate-100" id="faq">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mt-10 bg-gradient-to-r from-blue-950 via-slate-900 to-slate-950 p-6 rounded-2xl border border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left shadow-lg">
          ...
          <div className="flex items-center gap-2 font-sans">
            <a
              ...
              className="px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl text-xs font-black transition shadow-xs cursor-pointer flex items-center gap-1"
            >
              হোয়াটসঅ্যাপ
            </a>
            <a
              href="tel:+8801624933949"
              className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-xs font-black transition shadow-xs cursor-pointer flex items-center gap-1"
            >
              সরাসরি কল
            </a>
          </div>
